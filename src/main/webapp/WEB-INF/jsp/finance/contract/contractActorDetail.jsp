...
<html>
  <head>
    <base href="<%=basePath%>">
      ...
      <link rel="stylesheet" type="text/css" href="<%=basePath%>/css/finance/contract/ActorDetail.css">
      ...
      <script type="text/javascript" src="<%=basePath%>/js/finance/contract/contractActorDetail.js"></script>
  ...
  <body>
       ...
       <div class="my-container">
                  ...
                  <table cellspacing=0 cellpadding=0>
                    <tr>
                      <td class="popup-title">
                        <span class="right-popup-title">新增演员合同</span>
                      <td>
                      <td class="popup-btn-con">
                        <div class="popup-btn-list">
                            <input class="right-popup-save"  type="button" value='保存' onclick="saveActorContractInfo();">
                            <input class="right-popup-delete" type="button" value="删除" onclick="deleteActorContractInfo();">
          ...
          <div class="actor-detail-main" id="actorDetailMain">
              <div class="header-height">
                  <input type="hidden" id="contractId" value="${contractId }">
                  <input type="hidden" id="readonly" value="${readonly }">
                  <input type="hidden" id="contractNo">
                  <!-- <input type="hidden" name="subval" value="subject1" num="1"/> -->
                  <table class="actor-basic-info">
                      <tbody>
                          <tr class="info-title tr-height">
                              <td colspan="3" class="td-height">基本内容:</td>
                          </tr>
                          <tr class="tr-height">
                              <th><span class="must-info">*</span>演员姓名 : </th>
                              <td class="td-height">
                                  <input type="text" id="sonActorName" onclick="selectActorName(this)" onblur="autoAddRoleName(this)">
                              ...
                              <th class="second-th">角色 : </th>
                              <td class="td-height">
                                  <input type="text" id="sonRoleName">
                              </td>
                          </tr>
                  ...
                  <!-- 账户信息 -->
                  <table class="actor-account-info">
                      <tbody>
                          <tr class="info-title">
                                      ...
                                      <tbody>
                                          <tr class="byStageTr">
                                              ...
                                              <td class="payment-td">
                                                ...
                                                <span>期: <input class="stage-info" type="text" maxlength="180"  title="">,甲方向乙方支付酬金总额的
	                                                <input class="stage-money-part" type="text" maxlength="10" onblur="percentCalculation(this)">%,即
	                                                <input type="text" maxlength="10" onkeyup="" onblur="" class="stage-money">元整。
                                                </span>
                                                ...
                                                <!-- <input type="hidden" value="" />
                                                <span>
	                                                <input class="remark input-long" type="text" maxlength="180" onkeyup="setTitle(this);" >，甲方向乙方按月支付酬金，月薪为
	                                                <input class="month-money input-middle" type="text" maxlength="10">元,付款周期为
	                                                <input class="start-date input-middle" type="text" onClick="WdatePicker({readOnly:true,isShowClear:false})">至
	                                                <input class="end-date remind-input input-middle" type="text" onClick="WdatePicker({readOnly:true,isShowClear:false})">发薪日为每月
	                                                <input class="month-pay-day input-small" type="text" maxlength="2">日
                                                </span> -->
                                              </td>
                                          </tr>
                                      </tbody>
