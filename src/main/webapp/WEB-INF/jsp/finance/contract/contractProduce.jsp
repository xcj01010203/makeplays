...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>/js/finance/contract/contractProduce.js"></script>
    <script>
  ...
  <body>
      <div class="my-container">
            <div class="tab-body-wrap-actor" id="tabWrapActor">
                <div class="btn_tab_wrap-produce">
                  <!-- tab键空白处 -->
                    ...
                    <div class="tab_wrap">
                        <ul>
                            ...
                            <li class="tab_li_current" id="contractProduceTab"  >制作合同</li>
                            <li id="contractToPaidTab">合同批量支付</li>
                        </ul>
                    </div>
                </div>
                
                <div class="contract-public produce-contract-page">
                    <div class="contract-public" id="produceContractList"></div>
                    
                    <div class="produce-contract-total">
                    </div>
                </div>
                ...
                <div class="my-window-content" id="dropDownDIV">
                    <ul class="info-list">
                        <li class="select-picker-li">
                          <p>对方公司: </p>
                          <select id="company" class="selectpicker show-tick" multiple data-live-search="true" style="display: none;">
                        ...
                        <li class="select-picker-li">
                            <p>联系人 : </p>
                            <select id="contactPerson" class="selectpicker show-tick" multiple data-live-search="true" style="display: none;">
                    ...
                    <div class="win-btn-list-div">
                        <input type="button" id="advanceQueryBtn" value="查询"  onclick="advanceQueryProduce()">
      ...
      <!-- 导出职员合同方式窗口 -->
     <div class="hiddenWindow" id='exportContractProduceWindow'>
		<div id="exportContractProduceHeader">
			<span> 导出制作合同 </span>
		</div>
		<div id="exportContractProduceDiv">
			...
			<div style="text-align: center;">
				<input class="mybtn export" type="button" id="exportBtn" value="导出" onclick="confirmExportProduce()">
	 ...
	 <!--导入窗口  -->
	  <div id="importExportProduceWin" class="jqx-window">
			<div>导入</div>
				<div>
