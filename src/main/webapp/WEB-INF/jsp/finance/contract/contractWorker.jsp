...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>/js/bootstrap/bootstrap-select.js"></script>
		...
		<script type="text/javascript" src="<%=basePath%>/js/finance/contract/contractWorker.js"></script> 
		<script>
  ...
  <body>
     <div class="my-container">
            ...
            <div class="tab-body-wrap-worker">
                <div class="btn_tab_wrap-worker" id="tabWrapWorker">
                  <!-- tab键空白处 -->
                    ...
                    <div class="tab_wrap">
                        <ul>
                            <li id="contractWorkerTab" class="tab_li_current">职员合同</li>
                ...
                <!-- 职员合同 -->
                <div class="contract-public worker-contract-page">
                    <div class="contract-public" id="workerContractList"></div>
                    <div class="worker-contract-total"></div>
                </div>
                ...
                <div class="my-window-content" id="dropDownDIV">
                    <ul class="info-list">
                        <li class="select-picker-li">
		                      <p>职员姓名:</p>
		                      <select id="workerName" class="selectpicker show-tick" multiple data-live-search="true" style="display: none;">
                    ...
                    <div class="win-btn-list-div">
                        <input type="button" id="advanceQueryBtn" value="查询"  onclick="advanceQuery()">
						      ...
						      <table cellspacing=0 cellpadding=0>
						        <tr>
						          ...
						          <td class="popup-btn-con">
						            <input class="right-popup-save"  type="button" value='保存' onclick="saveContractInfo();">
     ...
     <!-- 导出职员合同方式窗口 -->
     <div class="hiddenWindow" id='exportContractWorkerWindow'>
		<div id="exportContractWorkerHeader">
			<span> 导出职员合同 </span>
		</div>
		<div id="exportContractWorkerDiv">
       ...
       <!--导入窗口  -->
	  <div id="importExportWorkerWin" class="jqx-window">
			<div>导入</div>
				<div>
