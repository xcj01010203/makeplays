...
$(document).ready(function () {
	...
	//$('#editor').jqxEditor({theme:theme,height: "580px",width: '580px',tools:"",pasteMode:"text"});
    ...
    $("#fileContent").bind('mouseup', function (event) {
    	var selecation = '';
            ...
            <input type="hidden" value="1" name="createWay"/>
                <table class="register-table">
                    <tr>
                        ...
                        <td width="60%" align="center">剧本内容</td>
                    </tr>
                    <tr>
                        ...
                        <td rowspan="16">
	                        <div id='content'>
	                        	<div id='editorDIV' >
						            ...
						            <textarea id="fileContent" name="fileContent" rows="" cols="" style=" width:580px; height:620px; border:2px solid #ff8432;background:#D8FFD5;"></textarea>
						        </div>
						    </div>
                        </td>
                    </tr>
