            ...
            <div>
                <form id="planForm" action="/shootPlanManager/saveShootPlan">
	                <table class="register-table">
	                    <tr>
	                        <td>计划名称:</td>
	                        <td><input type="text" name="planName" id="planNameInput" class="text-input" /></td>
	                    </tr>
	                    <c:if test="${shootPlanInfo != null and shootPlanInfo != undefined and shootPlanInfo != '' }">
	                        <tr>
	                            <td>上级计划名称:</td>
	                            <td><input type="text" name="parentPlanName"  value='${shootPlanInfo.planName }' class="text-input" style='color:grey' readonly/></td>
	                        </tr>
	                        <input type="hidden" name="parentPlanId" value="${shootPlanInfo.planId }">
	                    </c:if>
	                    <tr>
	                        <td>计划开始时间：</td>
	                        <td>
