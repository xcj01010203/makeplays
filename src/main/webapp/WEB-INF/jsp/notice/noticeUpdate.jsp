    ...
    var groupArray = [{text:"A组",value:"0"},{text:"B组",value:"1"},{text:"C组",value:"2"},{text:"D组",value:"3"},{text:"E组",value:"4"},
        ...
        $(document).ready(function () {
		    ...
		    for(var i=0;i<groupSource.length;i++){
		    	if(groupSource[i].value== "${noticeInfo.groupId}"){
		    		selectIndex=i;
		    		break;
		    	}
		    }
		    ...
		    //$("#noticeGroupDiv").jqxComboBox('checkIndex', selectIndex);
    ...
    <div>
        <div id="register" style=" margin-left: 200px;margin-top:50px">
            ...
            <div>
                ...
                <input type="hidden" value="${noticeInfo.noticeId }" name="noticeId">
	                <table class="register-table">
	                    <tr>
	                        <td>名称:</td>
	                        <td><input type="text" name="noticeName" id="noticeNameInput" class="text-input" value="${noticeInfo.noticeName }"/></td>
	                    </tr>
	                    <tr>
	                        <td>时间：</td>
	                        <td>
	                            ...
	                            value='<fmt:formatDate value="${noticeInfo.noticeDate }" pattern="yyyy/MM/dd"/>' />
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>分组:</td>
